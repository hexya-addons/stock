...
func init() {
	h.ReportStockForecast().DeclareModel()

	h.ReportStockForecast().AddFields(map[string]models.FieldDefinition{
		...
		"CumulativeQuantity": models.FloatField{
	...
	h.ReportStockForecast().Methods().Init().DeclareMethod(
		`Init`,
		func(rs m.ReportStockForecastSet) {
